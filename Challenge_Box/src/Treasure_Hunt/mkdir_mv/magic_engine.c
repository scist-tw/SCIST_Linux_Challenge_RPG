...
char cipher1[] = {0x34, 0x7c, 0x5c, 0x9e, 0x93, 0xf9, 0xc4, 0x11, 0x7a, 0xc1, 0x54, 0x53, 0xda, 0x8e, 0xa, 0xfe, 0x8f, 0x63, 0x5f, 0xde, 0xd3, 0x86, 0x87, 0x93, 0x6c, 0x79, 0x2a, 0xdd, 0x9f, 0xa1, 0x5e, 0x92, 0xd2, 0x78, 0x4c, 0xca, 0xfb, 0x17, 0xb, 0x49, 0x96, 0xe5, 0xce, 0xa7, 0xcd, 0x69, 0xb6, 0xa5, 0x12};
char cipher2[] = {0x34, 0x7c, 0x5c, 0x9e, 0x93, 0xf9, 0xd0, 0x15, 0x6e, 0x84, 0x68, 0x78, 0xd7, 0x81, 0x19, 0xb0, 0x92, 0x59, 0x72, 0xd3, 0xdb, 0x8b, 0x80, 0xdc, 0x14, 0x5a, 0x14, 0xd8, 0x82, 0xeb, 0x64, 0x9e, 0xc9, 0x78, 0x52, 0xfe, 0xfb, 0xa, 0x33, 0x65, 0x8c, 0xe3, 0xcc, 0xbe, 0xd0, 0x51, 0xd7, 0xb8, 0x50, 0xbb, 0xb2};
...
int main(int argc, char **argv) {
    ...
    if (is_same_path(binary_path, shipwreck_path) == 1) {
        print_flag(cipher1, 49);
        printf("Task Prompt : Well the magic engine just work on ship call Titanic.\n\n");
        puts("Side Quest : Chinese Parents' Challenge (challenge is in `~/Chinese_Parents_Challenge/`)");
        ...
        puts("2. base64 : Decode the string");
    ...
    if (is_same_path(binary_path, titanic_path) == 1) {
